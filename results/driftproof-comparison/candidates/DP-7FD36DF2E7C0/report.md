# DriftProof review: DP-7FD36DF2E7C0

- **Verdict:** `approve`
- **Build isolation:** `bubblewrap`
- **Build return code:** `0`
- **Certificate:** `7284b1707c274c52628140adf1839fbb28fa861e96a5ee633a13ad878a892991`
...
|---|---|---|---|
| `pass` | **Candidate builds from the disposable review worktree** (`C-C0B46176F241`) | dbt returned 0 under bubblewrap isolation. | `dbt build`<br>`6b3985ad7bdb980dea8060d9b5ed3cdb64aeb696df875a38993a147acf8ef4f5` |
| `pass` | **Original candidate project remained unchanged** (`C-2EE4ED4DFCAA`) | The source tree hash is unchanged. | `6b3985ad7bdb980dea8060d9b5ed3cdb64aeb696df875a38993a147acf8ef4f5`<br>`6b3985ad7bdb980dea8060d9b5ed3cdb64aeb696df875a38993a147acf8ef4f5` |
...
| `pass` | **Invalid numeric input follows the documented NULL policy** (`C-88B26083405B`) | Invalid numeric text remains NULL after an explicit DECIMAL try_cast. | `models/stg_orders.sql` |
...
- Candidate tree SHA-256: `6b3985ad7bdb980dea8060d9b5ed3cdb64aeb696df875a38993a147acf8ef4f5`
- Business context SHA-256: `732f7c4b698ecb118aa8926c623a9c91922c2a7655e1d340c64aef1e4c2ff856`
- Disposable worktree SHA-256: `6b3985ad7bdb980dea8060d9b5ed3cdb64aeb696df875a38993a147acf8ef4f5`
- Certificate SHA-256: `7284b1707c274c52628140adf1839fbb28fa861e96a5ee633a13ad878a892991`
